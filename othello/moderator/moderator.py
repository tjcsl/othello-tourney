...
class Moderator:
    def __init__(self):
        self.board: dict[int, int] = (
            constants.INITIAL
        )  # bitboards representation of the initial othello board
    ...
    def possible_moves(self, player: int | None = None) -> int:
    ...
    def submit_move(self, submitted_move: int) -> list[int] | None:
